  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <h2 style={{
          fontFamily: GRIFT,
          fontWeight: 800, fontSize: 54, lineHeight: 1.0,
        ...
        <div style={{ display: 'flex', gap: 40, marginTop: 40 }}>
          <div>
            <div style={{ fontFamily: GRIFT, fontWeight: 900, fontSize: 76, color: HM.bone, lineHeight: 1, letterSpacing: '0.01em' }}>{teachers}</div>
            <div style={{ fontFamily: DM, fontWeight: 300, fontSize: 12, letterSpacing: '0.1em', textTransform: 'uppercase', color: HM.tuscany, marginTop: 4 }}>Teachers</div>
          </div>
          <div>
            <div style={{ fontFamily: GRIFT, fontWeight: 900, fontSize: 76, color: HM.bone, lineHeight: 1, letterSpacing: '0.01em' }}>
              {weeks}<span style={{ fontSize: 34, fontWeight: 700 }}>wk</span>
            </div>
            <div style={{ fontFamily: DM, fontWeight: 300, fontSize: 12, letterSpacing: '0.1em', textTransform: 'uppercase', color: HM.tuscany, marginTop: 4 }}>Duration</div>
          </div>
        </div>
      </div>
    ...
    <div style={{
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div style={{
          ...
          fontFamily: DM, fontWeight: 300, fontSize: 12, letterSpacing: '0.08em',
        }}>
          <span style={{ color: HM.tuscany, textTransform: 'uppercase', fontWeight: 600 }}>Outcome</span>
          <span style={{ color: HM.ink, fontWeight: 400, fontSize: 15 }}>{outcome}</span>
        </div>
      </div>
