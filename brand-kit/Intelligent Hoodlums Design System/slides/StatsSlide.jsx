  ...
  <div style={{
    ...
    <div style={{ padding: '100px 80px 48px', flexShrink: 0, position: 'relative', zIndex: 1 }}>
      ...
      <h2 style={{
        ...
        color: HM.bone, margin: '0 0 20px', letterSpacing: '0.01em',
        whiteSpace: 'pre-line',
      }}>{headline}</h2>
      <RufousRule width={56} />
    </div>
    ...
    <div style={{
      ...
      {stats.map((s, i) => (
        <div key={i} style={{
          ...
          <div style={{
            fontFamily: DM,
            fontWeight: 500, fontSize: 17, color: HM.tuscany,
            marginTop: 10, marginBottom: 8, lineHeight: 1.3,
          }}>{s.label}</div>
          <div style={{
            fontFamily: DM,
    ...
    <div style={{
      ...
      fontFamily: DM, fontWeight: 300, fontSize: 13, letterSpacing: '0.06em',
      position: 'relative', zIndex: 1,
    }}>
      <span style={{ color: HM.tuscany, textTransform: 'uppercase', letterSpacing: '0.1em', flexShrink: 0, fontWeight: 600 }}>Crew Talk</span>
