...
window.STEM_DATA = [
  ...
  { n: 5,  symbol: 'CP',   name: 'Carolyn Parker',           years: '1917–1966', field: 'biology',        status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 9,  symbol: 'EN',   name: 'Evelyn Nicol',             years: '',          field: 'biology',        status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 13, symbol: 'BSL',  name: 'Beebe Steven Lynk',        years: '1872–1948', field: 'chemistry',      status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 27, symbol: 'LDN',  name: 'Lyda D. Newman',           years: '1885–1920', field: 'innovation',     status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 33, symbol: 'LBL',  name: 'Lillian Burwell Lewis',    years: '1904–1987', field: 'biology',        status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 43, symbol: 'MT',   name: 'Madeline Turner',          years: '',          field: 'innovation',     status: 'ghosted', bio: '', artifact: '' },
  { n: 44, symbol: 'MJ',   name: 'Martha Jones',             years: '',          field: 'innovation',     status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 48, symbol: 'DJ',   name: 'Deborah Jackson',          years: '',          field: 'physics',        status: 'ghosted', bio: '', artifact: '' },
  { n: 49, symbol: 'RSL',  name: 'Ruth Smith Lloyd',         years: '1917–1995', field: 'biology',        status: 'ghosted', bio: '', artifact: '' },
  { n: 50, symbol: 'AJJ',  name: 'Anna Johnson Julian',      years: '1903–1994', field: 'socialScience',  status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 61, symbol: 'BWG',  name: 'Bettye Washington Greene', years: '1934–1995', field: 'chemistry',      status: 'ghosted', bio: '', artifact: '' },
  ...
  { n: 65, symbol: 'SEK',  name: 'Sinah Estelle Kelley',     years: '1916–1982', field: 'chemistry',      status: 'ghosted', bio: '', artifact: '' },
